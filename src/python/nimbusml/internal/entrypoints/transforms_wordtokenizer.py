...
def transforms_wordtokenizer(
    ...
    **Description**
    ...
    :param term_separators: Comma separated set of term separator(s).
        Commonly: 'space', 'comma', 'semicolon' or other single
        character. (inputs).
    ...
    if data is not None:
        inputs['Data'] = try_set(
            ...
            is_of_type=str)
    if term_separators is not None:
        inputs['TermSeparators'] = try_set(
            obj=term_separators,
            none_acceptable=True,
            is_of_type=str)
